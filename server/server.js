...
var Course1 = /** @class */ (function () {
    function Course1(id, courseName, images, courseDetail, task, person) {
        this.id = id;
        this.courseName = courseName;
        this.images = images;
...
exports.Course = Course1;


var passage = /** @class */ (function () {
    function passage(id, images1, images2, passageName, passageDetail,person,date) {
        this.id = id;
...
const courses2=[
  ...
  "http://usercontent.edu2act.cn/media/cs/17-02-20/BRmabjXmc6M87Hx678jgkk.png?imageView2/1/w/320/h/190",
    "完成本课程之后，能够达到以下目标:实名注册Github账户,能够在Github账户上搜索资料",16,3739),
